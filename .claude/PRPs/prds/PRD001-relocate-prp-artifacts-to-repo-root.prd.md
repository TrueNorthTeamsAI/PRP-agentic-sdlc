...
|---|-------|-------------|--------|----------|---------|----------|
| 1 | Plugin path migration | Replace `.claude/PRPs/` with `PRPs/` across all plugin command, skill, template, and script files | in-progress | - | - | `.claude/PRPs/plans/PRD001-P001-plugin-path-migration.plan.md` |
