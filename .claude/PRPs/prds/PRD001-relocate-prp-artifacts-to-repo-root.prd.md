...
| 3 | Docs + scaffolding update | Update root CLAUDE.md, READMEs, `init-project` scaffolding, and `claude_md_files/` templates | in-progress | with 1 | - | `.claude/PRPs/plans/PRD001-P003-docs-and-scaffolding-update.plan.md` |
